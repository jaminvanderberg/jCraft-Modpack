...
var block = [
	...
	,<GalacticraftCore:tile.gcBlockCore:10>
	,<Mekanism:BasicBlock:13>
	,<ProjRed|Exploration:projectred.exploration.stone:9>
	,<Railcraft:cube:10>
...
var ingot = [
	...
	,<Mekanism:Ingot:6>
	,<ProjRed|Core:projectred.core.part:53>
	,<Railcraft:ingot:2>
	,<TConstruct:materials:10>
	,<RotaryCraft:rotarycraft_item_modingots:0>
] as IItemStack[];
...
var ore = [
	...
	,<TConstruct:GravelOre:3>	// Using blank RotaryCraft ore for TC gravel ore.  Shouldn't hurt anything
] as IItemStack[];
