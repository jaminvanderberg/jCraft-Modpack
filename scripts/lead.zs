...
val ingotNether = <RotaryCraft:rotarycraft_item_modingots:37>;
...
val dustMek = <Mekanism:Dust:6>;
val dustDirty = <Mekanism:DirtyDust:6>;
val dustIE = <ImmersiveEngineering:metal:12>;
val dustSecondary = <ThermalFoundation:material:34>;
val dustAOBD = <aobd:crushedLead>;
val dustMC = <Magneticraft:item.dust_lead>;
val chunk = <Magneticraft:item.chunk_lead>;
val rubble = <Magneticraft:item.rubble_lead>;
val pebbles = <Magneticraft:item.pebbles_lead>;

// Intermediate States
val cluster = <Thaumcraft:ItemNugget:20>;
val dustOre = <ore:dustLead>;
val oreOre = <ore:oreLead>;
val nuggetOre = <ore:nuggetLead>;
val ingotOre = <ore:ingotLead>;
val liquid = <liquid:lead.molten>;
var iliqIngot = 144;
var iliqBlock = iliqIngot * 9;
val flakes = <RotaryCraft:rotarycraft_item_modextracts:11>;
val nflakes = <RotaryCraft:rotarycraft_item_modextracts:151>;
val orePoor = <Railcraft:ore:11>;
val oreNether = <NetherOres:tile.netherores.ore.0:10>;
val oreDense = <denseores:block0:11>;
val minechem = <minechem:minechemElement:82>;

val ingotOutput = <ThermalFoundation:material:67>;
val blockOutput = <ThermalFoundation:Storage:3>;
val nuggetOutput = <ThermalFoundation:material:99>;
val oreOutput = <ThermalFoundation:Ore:3>;
val dustOutput = <ThermalFoundation:material:35>;
...
for i, bl in block {
	recipes.remove( bl );
	bl.displayName = "Block of Lead";
}

blockOutput.displayName = "Block of Lead";
...
dustDirty.displayName = "Dirty Pulverized Lead";
